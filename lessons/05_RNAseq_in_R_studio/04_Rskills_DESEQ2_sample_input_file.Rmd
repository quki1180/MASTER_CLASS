...
mine: counts_matrix <- read.table("/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/quki1180/MASTER_CLASS/data/salmon.merged.gene_counts.tsv", header=TRUE, row.names=1)

# Remove gene name column
counts_matrix <-counts_matrix %>% 
  select(-"gene_name") 
View(counts_matrix)
Must use: library(magrittar)
library(tidyr)
library(dplyr)
